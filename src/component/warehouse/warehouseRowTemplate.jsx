...
function warehouseRowTemplate(item, i, openIndex, setOpenIndex) {
  ...
  return (
    ...
    >
      ...
      <td className="text-[rgb(177,117,115)] py-4">{item?.warehouse}</td>
      <td className="table-cell text-start">{item?.warehouse_slug}</td>
...
export default warehouseRowTemplate;
