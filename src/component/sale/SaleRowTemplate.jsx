...
function SaleRowTemplate(item, i, openIndex, setOpenIndex) {
  ...
  return (
    ...
    >
      <td className="text-[rgb(177,117,115)] py-4">{item?.sale_date}</td>
      <td className="table-cell text-start">{item?.customer}</td>
      <td className="table-cell text-start">{item?.warehouse}</td>
      <td className="table-cell text-start">{item?.discount}</td>
      <td className="table-cell text-start">{item?.order_tax}</td>
      <td className="table-cell text-start">
        <div className="text-white bg-[rgb(22,211,154)] rounded-sm w-[50px] px-[3px] text-[11px]">
          {item?.delivery_status}
        </div>
      </td>
      <td className="table-cell text-start ">{item?.sale_status}</td>
      <td className="table-cell text-start">
...
export default SaleRowTemplate;
