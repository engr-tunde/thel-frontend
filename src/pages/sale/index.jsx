...
import { ViewPurchases } from "../../data/purchases";
...
import { saleListTableColumn } from "../../data/sale";
import SaleRowTemplate from "../../component/sale/SaleRowTemplate";
    ...
    <div className="mt-8 w-full flex flex-col">
      ...
      <div className="flex flex-col">
        <div className="flex gap-2 pb-5">
          <FormModal type="create" table="sale" title="Add Sale" />
        </div>
