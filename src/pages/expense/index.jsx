    ...
    <div className="mt-8 w-full flex flex-col">
      ...
      <div className="flex flex-col">
        <div className="flex gap-2 pb-5">
          <FormModal type="create" table="expense" title="Add Expense" />
      ...
      <div className="flex w-full justify-between items-center mt-10 mb-10">
        ...
        <div className="flex items-center justify-center gap-[4px] relative">
          ...
          <div
            onMouseLeave={handleViewExpense}
            className={
              viewExpense
      ...
      {data ? (
        <Table
          tableColumn={expenseTableColumn}
          rowData={data?.data}
          rowTemplate={ExpenseRowTemplate}
        />
      ) : loading ? (
        <Loader />
      ) : null}
