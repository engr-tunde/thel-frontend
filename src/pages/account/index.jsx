...
import { fetchAllAccount } from "../../api";
import Loader from "../../component/global/Loader";
import { accountTableColumn, ViewAccount } from "../../data/account";
import accountRowTemplate from "../../component/account/accountRowTemplate";

const AccountListPage = () => {
  const [viewAccount, setviewAccount] = useState(false);

  const { data, loading, error, mutate } = fetchAllAccount();
    ...
    <div className="mt-8 w-full flex flex-col">
      ...
      <div className="flex flex-col">
        <div className="flex gap-2 pb-5">
          <FormModal type="create" table="account" title="Add Account" />
        </div>
      </div>
      {/* main second section */}
      <div className="flex w-full justify-between items-center mt-10 mb-10">
        ...
        <div className="flex items-center justify-center gap-[4px] relative">
          ...
          <div
            onMouseLeave={handleViewAccount}
            className={
              viewAccount
      ...
      {data ? (
        <Table
          tableColumn={accountTableColumn}
          rowData={data?.data}
          rowTemplate={accountRowTemplate}
          checkAll={true}
        />
      ) : loading ? (
        <Loader />
