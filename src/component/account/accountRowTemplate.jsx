...
function accountRowTemplate(item, i, openIndex, setOpenIndex) {
  ...
  return (
    ...
    >
      ...
      <td className="text-[rgb(177,117,115)] py-4">{item?.bank_name}</td>
      <td className="table-cell text-start">{item?.account_name}</td>
      <td className="table-cell text-start">{item?.account_number}</td>
      <td className="table-cell text-start">{item?.initial_balance}</td>
      <td className="table-cell text-start">{item?.available_balance}</td>
...
export default accountRowTemplate;
